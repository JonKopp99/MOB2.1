...
*/
let namedGroucho = NSPredicate(format: "name = %@", NSString(string: "Groucho")) // 61 here is @61: NSNumber
people.filtered(using: namedGroucho)
...
*/
let allOverFifty = NSPredicate(format: "age >= %i", 50)
people.filtered(using: allOverFifty)
